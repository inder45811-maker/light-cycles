...
__all__ = ["battles_router", "tournaments_router", "debates_router", "pits_router", "auth_router", "promo_router", "edu_router", "seo_router", "agent_router", "post_router", "health_router", "websocket_router"]
